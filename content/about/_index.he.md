+++
title = "אודות מארק ולצר"
description = "מארק ולצר הוא מהנדס תוכנה מישראל העובד בלינוקס, C, C++, פייתון וראסט, ומלמד וכותב על תכנות, מתמטיקה ופילוסופיה."
template = "section.html"
+++

שמי מארק ולצר ואני מהנדס תוכנה מישראל.

אני עובד בעיקר סביב לינוקס -- C, C++, פייתון, ראסט ושכבת המערכת שמתחתיהם --
ובחלק ניכר מהקריירה שלי גם לימדתי את הנושאים האלה וכתבתי עליהם. חלק גדול מחומרי
ההוראה שלי מפורסם באתר הזה תחת [סילבוסים](/he/syllabi/) ו[מצגות](/he/slides/).

מחוץ לעבודה אני קורא ומאזין הרבה, משחק שחמט, ומתעד את שניהם בפומבי: מדור
[מדיה](/he/media/) עוקב אחרי הספרים, ההרצאות, הקורסים והסרטים שאני עובר עליהם,
ו[שחמט](/he/chess/) מכיל את המשחקים שלי עם מציג שמאפשר לשחזר אותם. ה[בלוג](/he/blog/)
הוא המקום לכתיבה הארוכה יותר, באנגלית ובעברית, על תכנות, מתמטיקה, דת ופילוסופיה.

קישורי הפרופילים שלמטה הם שאר המקומות שבהם אני נמצא ברשת.
