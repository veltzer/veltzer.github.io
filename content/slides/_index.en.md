...
description = "Browse Mark Veltzer's teaching slides by course and lecture, with a PDF of every deck."
template = "app.html"
+++
...
<h2>Course &amp; Lecture Browser</h2>

</div>
<p id="total-count">188 items</p>
...
<md-select-option value="architecture:patterns"><div slot="headline">architecture:patterns</div></md-select-option>
...
<md-select-option value="messaging:overview"><div slot="headline">messaging:overview</div></md-select-option>
...
<md-select-option value="practices:chaos-testing"><div slot="headline">practices:chaos-testing</div></md-select-option>
...
<md-select-option value="practices:contract-testing"><div slot="headline">practices:contract-testing</div></md-select-option>
...
<md-select-option value="practices:performance-testing"><div slot="headline">practices:performance-testing</div></md-select-option>
...
<p class="build-info">Built from <code>25d0544ec0ff</code> on 2026-09-16 07:09 UTC &middot; local build</p>
</div>
</div>
