...
<body class="antialiased text-gray-800">
    ...
    <div class="container mx-auto p-4 md:p-8">
        ...
        <!-- Search Input -->
        <div id="search-container" class="mb-8 max-w-2xl mx-auto">
        ...
        <main id="content-container">
            ...
            <section id="items-container" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></section>
        </main>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function generateNav(activeDataType, showStatsOnly) {
                ...
                // Add the toggle button for stats view
                const statsToggle = document.createElement('a');
                statsToggle.className = 'nav-button px-4 py-2 md:px-6 md:py-3 rounded-full bg-white shadow-sm hover:bg-gray-100 border-2 border-indigo-500 ml-4';
            ...
            async function loadData() {
                ...
                // Show/hide content based on view mode
                if (showStatsOnly) {
